...
<template>
  <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    <div class="container">
      <RouterLink to="/" class="navbar-brand" href="localhost:51">
        <span style="color: white">R-T-STS</span>
      </RouterLink>
      <button
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        ...
        <button
          ...
          style="margin: 0; height: 38px; padding: 3px 0px 3px 6px"
        >
  ...
  <div style="min-height: 10vh">
    <footer class="border-top py-4 container">
      <div class="text-center">
        <ul class="nav list-unstyled justify-content-center">
          <li class="text-muted">&copy;2024 | Hossein Ebrahimi |</li>
          <li class="ms-1">
            <a class="text-muted" href="https://github.com/xc6pm">
              <svg
          ...
          <li class="">
            <a class="text-muted" href="https://www.linkedin.com/in/hossein-ebrahimi-6a393b1b2/">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
                fill="currentColor"
                class="bi bi-linkedin text-muted"
                viewBox="0 0 20 20"
              >
                <path
