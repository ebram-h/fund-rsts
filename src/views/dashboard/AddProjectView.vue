...
<template>
  <div id="projectForm">
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="titleInput" v-model="state.title" minlength="3" />
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="descriptionInput" v-model="state.description" />
    </div>
    <div class="mb-3">
      <label for="recipientInput" class="form-label">Recipient</label>
      <div class="row g-0">
        <div class="col">
          <input type="text" class="form-control" id="recipientInput" v-model="state.recipient" />
        </div>
